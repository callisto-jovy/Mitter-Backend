/*
 * * <p> * Materialien zu den zentralen NRW-Abiturpruefungen im Fach Informatik ab 2018 * </p> * <p> * Klasse Server * </p> * <p> * Objekte von Unterklassen der 
 * abstrakten 
 * Klasse Server ermoeglichen das * Anbieten von Serverdiensten, so dass Clients Verbindungen zum Server mittels * TCP/IP-Protokoll aufbauen koennen. Zur Vereinfachung 
 * finden 
 * Nachrichtenversand * und -empfang zeilenweise statt, d. h., beim Senden einer Zeichenkette wird ein * Zeilentrenner ergaenzt und beim Empfang wird dieser entfernt. 
 * Verbindungsannahme, Nachrichtenempfang und Verbindungsende geschehen * nebenlaeufig. Auf diese Ereignisse muss durch Ueberschreiben der entsprechenden * 
 * Ereignisbehandlungsmethoden reagiert werden. Es findet nur eine rudimentaere * Fehlerbehandlung statt, so dass z.B. Verbindungsabbrueche nicht zu einem * 
 * Programmabbruch fuehren. Einmal unterbrochene oder getrennte Verbindungen * koennen nicht reaktiviert werden.  * </p> * * @author Qualitaets- und 
 * UnterstuetzungsAgentur - Landesinstitut fuer Schule * @version 30.08.2016 */
import java.net.*;
import java.io.*;
public abstract class Server
{    
    private NewConnectionHandler connectionHandler;    
    private SchoolList<ClientMessageHandler> messageHandlers;    
